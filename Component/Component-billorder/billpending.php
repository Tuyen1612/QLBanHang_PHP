<?php 
    ...
    $bills =findBillByIdReaderAndStatus($_SESSION["account"]["maDG"],0,$conn) ->fetchAll();
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a class="btn btn-info" title=""
                                                    data-toggle="tooltip" href="<?php echo $level.pages_path_WEB."post/detailBill.php?idBill=".$bill["MaHoaDon"];  ?>"
