<?php
  ...
  $date = date('Y-m-d');
  $lstBill = findBillByStatus(0,$conn);
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-primary">
                    <h4 class="card-title ">Danh Sách Hóa Đơn Đang Chờ Duyệt</h4>
                    <p class="card-category"> Thông tin các hóa đơn đang chờ duyệt trong ngày</p>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo "Chờ Duyệt"; ?></td>
                                    <td><a href="<?php echo $level.pages_path_AD."post/updateStatusBill.php?id=".$bill["MaHoaDon"]."&status=1"?>"
                                            title="Settings" data-toggle="tooltip"><i
                                                class="material-icons">check_circle</i></a>
                                        <a href="<?php echo $level.pages_path_AD."post/updateStatusBill.php?id=".$bill["MaHoaDon"]."&status=-1"?>"
